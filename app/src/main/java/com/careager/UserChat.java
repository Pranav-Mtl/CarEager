...
import com.careager.Adapter.UserChatListAdapter;
...
public class UserChat extends AppCompatActivity implements View.OnClickListener {
    ...
    ListView recList;
    UserChatListAdapter objUserChatAdapter;
    ...
    private void populateChatMessages() {
        ...
        if (ChatPeoples.size() > 0) {
            objUserChatAdapter = new UserChatListAdapter(this, ChatPeoples);
            recList.setAdapter(objUserChatAdapter);
        }
    ...
    void getData() {
        ...
        Cursor cursor = dbOperation.getDataFromTable(dealerID);
...
// you can get seconds by adding  "...:ss" to it
    ...
    private class SendChatData extends AsyncTask<String,String,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            String text="";
            String URL="sender_id="+params[0]+"&reciever_id="+params[1]+"&message="+params[2]+"&type="+params[3];
            text = RestFullWS.serverRequest(Constant.WS_PATH_USER, URL, Constant.WS_CHAT);
    ...
    protected void onResume() {
        super.onResume();
        Constant.flatGCM=true;
    }

    @Override
    protected void onPause() {
        super.onPause();
        Constant.flatGCM=false;
    }
}
